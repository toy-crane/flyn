...
10. Home 헤더에 **새 대화**가 없고, 오른쪽 프로필로 설정을 열었다 돌아올 수 있는지
    확인합니다. 에피소드에서 배울 표현 카드의 **AI에게 물어보기**를 열고 질문을
    보내 답변을 확인합니다. 시트를 닫았다 같은 카드에서 다시 열면 대화가 남아 있어야 합니다.
11. Home 본문의 **1화 시작하기**를 눌러, 입력하기 전에 카페 장면이 먼저
    열리는지 확인합니다. 영어로 몇 번 주고받아 사건을 마무리하면 결말과 2화 예고가
    함께 나오고 입력이 닫히는지 확인합니다. **홈으로 가기**를 누르면 Home에 2화 예고
    카드와 끝낸 화 목록이 남아 있어야 합니다. 끝낸 화의
    **1화 카페에서 생긴 일, 성공, 대화 보기**를 눌러
    첫 장면부터 결말까지 보이고 입력창은 없는지 확인합니다.
12. 설정에서 로그아웃합니다.

...
SELECT results_eq($$SELECT to_jsonb(r) - 'updated_at' FROM public.stories r ORDER BY to_jsonb(r) - 'updated_at'$$,
 $$SELECT to_jsonb(r) FROM ci_timestamps.stories r ORDER BY to_jsonb(r)$$,
...
SELECT results_eq($$SELECT to_jsonb(r) - 'updated_at' - 'created_at' FROM public.characters r ORDER BY to_jsonb(r) - 'updated_at' - 'created_at'$$,
...
SELECT results_eq($$SELECT to_jsonb(r) - 'updated_at' - 'created_at' FROM public.episodes r ORDER BY to_jsonb(r) - 'updated_at' - 'created_at'$$,
 $$SELECT to_jsonb(r) FROM ci_timestamps.episodes r ORDER BY to_jsonb(r)$$,
...
SELECT results_eq($$SELECT to_jsonb(r) - 'updated_at' - 'created_at' FROM public.episode_characters r ORDER BY to_jsonb(r) - 'updated_at' - 'created_at'$$,
 $$SELECT to_jsonb(r) FROM ci_timestamps.episode_characters r ORDER BY to_jsonb(r)$$,
...
SELECT results_eq($$SELECT to_jsonb(r) - 'updated_at' FROM public.episode_messages r ORDER BY to_jsonb(r) - 'updated_at'$$,
 $$SELECT to_jsonb(r) FROM ci_timestamps.episode_messages r ORDER BY to_jsonb(r)$$,

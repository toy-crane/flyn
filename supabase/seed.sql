...
- 다른 손님과 주변 상황은 지문으로 전한다.$content$,
...
- 다른 투숙객과 주변 상황은 지문으로 전한다.$content$,
...
- 식당 직원과 주변 상황은 지문으로 전한다.$content$,
  array[$content$Daniel$content$],
...
- 택시 기사와 주변 상황은 지문으로 전한다.$content$,
  array[$content$Anna$content$],
...
- 지난 한 달의 일은 지문과 대사로 되짚는다.$content$,
  array[$content$Jamie$content$],
...
- 다른 팀원과 사무실 풍경은 지문으로 전한다.$content$,
...
- 다른 주민과 주변 상황은 지문으로 전한다.$content$,
...
- 택배 기사와 다른 주민은 지문으로 전한다.$content$,
...
- Frank와 다른 주민은 지문으로 전한다.$content$,
  array[$content$Nora$content$],

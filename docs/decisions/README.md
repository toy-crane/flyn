...
- [Worktree 개발 세션](worktree-development-sessions.md) — 여러 Git worktree의 API·Metro 포트, 같은 컴퓨터의 다른 프로젝트와 나누는 포트 대역, 로컬 Supabase 포트, 플랫폼 동시 실행, 실기기 LAN 연결, 기기 풀과 배정, 프로세스 소유권 또는 공용 Development Build 재사용 방식을 변경할 때 읽는다.
